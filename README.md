...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-08-23 00:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e1325b20-4fbf-4e42-a7ad-3b3db8832c8a.git
$ cd e1325b20-4fbf-4e42-a7ad-3b3db8832c8a
```
